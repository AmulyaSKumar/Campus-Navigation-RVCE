          ...
          {suggestions.map((place, index) => (
            <li
              ...
              className="py-3 px-4 cursor-pointer transition-all duration-200 
                         ...
                         active:bg-blue-100"
            >
              <svg className="w-4 h-4 text-blue-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" /></svg>
              {place.name}
            </li>
          ))}
        </ul>
